# -*- coding: utf-8 -*-
"""
Created on Mon Sep 17 17:35:35 2018
...
dtc = DecisionTreeClassifier(max_depth=best_n)

# Creating submission
create_submission(dtc, train_data, test_data, predictors, "titanic_submission.csv")